...
pacman -S xorg-server xorg-xinit xfce4-terminal lightdm lightdm-slick-greeter xfce4-power-manager xorg-mkfontscale picom nodejs feh papirus-icon-theme arc-gtk-theme alsa-utils dmenu dunst rofi python-psutil python-dbus-next pulseaudio pulseaudio-bluetooth pavucontrol --noconfirm > /dev/null
